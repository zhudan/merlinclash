				...
				if (arr[0] == "" || arr[1] == "") {
					...
					if(db_merlinclash["merlinclash_flag"] != "OTH"){
						...
						if (hostname.indexOf('.kooldns.cn') != -1 || hostname.indexOf('.ddnsto.com') != -1 || hostname.indexOf('.tocmcc.cn') != -1) {
							...
							razordHref =  protocol + '//' + hostname + "/ui/razord/index.html?host=" + hostname + "&port=" + port + "&secret=" + arr[16];
						}else{
							yacdHref   = "http://"+ location.hostname + ":" +arr[3]+ "/ui/yacd/index.html?hostname=" + location.hostname + "&port=" + arr[3] + "&secret=" + arr[16];
							razordHref = "http://"+ location.hostname + ":" +arr[3]+ "/ui/razord/index.html#/proxies?host=" + location.hostname + "&port=" + arr[3] + "&secret=" + arr[16];
						}
						
						$("#yacd").html("<a type='button' style='vertical-align: middle; cursor:pointer;' class='ss_btn' href='" + yacdHref + "' target='_blank' >访问 YACD-Clash 面板</a>");
						$("#razord").html("<a type='button' style='vertical-align: middle; cursor:pointer;' class='ss_btn' href='"+ razordHref + "' target='_blank' >访问 RAZORD-Clash 面板</a>");
					}else{
...
function version_show() {
	...
	if(db_merlinclash["merlinclash_flag"] == "HND" && db_merlinclash["merlinclash_flag2"] == "HND2"){
		raw_url="https://raw.githubusercontent.com/flyhigherpi/MCyuKP/main/QCA/config.json.js"
	}else if(db_merlinclash["merlinclash_flag"] == "384"){
		raw_url="https://raw.githubusercontent.com/flyhigherpi/MCyuKP/main/384/config.json.js"
		...
		raw_url="https://raw.githubusercontent.com/flyhigherpi/MCyuKP/main/HND/config.json.js"
	}
	$.ajax({
		url: raw_url,
		type: 'GET',
...
function addTr() {
	...
	$.ajax({
		...
		success: function(response) {
			...
			E("merlinclash_acl_protocol").value = "none"
		}
	});
	aclid = 0;
}
								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										...
										<div id="vpnc_settings" class="contentMKP_qis" style="box-shadow: 3px 3px 10px #000;margin-top: -65px;display: none;">
											...
											<div style="margin-left:15px"><i>1&nbsp;&nbsp;点击【保存文件】按钮，文本框内的内容会保存到/koolshare/merlinclash/koolproxy/data/user.txt。</i></div>
															...
															<div>
																<div style="display: flex;">
																	<div style="width: 61.8%">
																		<p><span class="ip-title">国内</span>:&nbsp;<span id="ip-ipipnet"></span></p>
																		<p><span class="ip-title">海外</span>:&nbsp;<span id="ip-ipapi"></span>&nbsp;<span id="ip-ipapi-geo"></span></p>
																	</div>
																	<div style="width: 40%">
											...
											<table style="margin:10px 0px 0px 0px;border-collapse:collapse" width="100%" height="37px">
												<tr>
													<td cellpadding="0" cellspacing="0" style="padding:0" border="1" bordercolor="#222">
														...
														<input id="show_btn5" class="show-btn5" width="11%" style="cursor:pointer" type="button" value="护娃狂魔" />
											...
											<div id="merlinclash-content-overview">												
												...
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_switch_table">
													...
													<tr>
														...
														<tr>
															<th id="btn-dnsmasqrestart" class="btn btn-primary">重建DNSMASQ</th>
																<td colspan="2">
																	<div class="merlinclash-btn-dnsmasqrestart">																	
																		<a type="button" style="vertical-align: middle; cursor:pointer;" class="ss_btn" id="dnsmasqrestart" onclick="dnsmasq_restart()">&nbsp;&nbsp;重建DNSMASQ&nbsp;&nbsp;</a>&nbsp;&nbsp;Clash异常退出断网点我试试												
																	</div>
																</td>
														</tr>
														<tr>
										...
										<div id="tablet_2" style="display: none;">
											...
											<div id="merlinclash_cusrule_edit_content" style="margin-top:-1px;overflow:hidden;">
												...
												<div style="text-align:center;vertical-align:middel;"><input class="ss_btn" type="button" onclick="cusrulechange()" value="修改提交"></div>
											</div>
														...
														<tr id="ena_sniffer">
															<th>Sniffer域名嗅探 --<a class="hintstyle" href="javascript:void(0);" onclick="openmcHint(29)"><em style="color: gold;">【Netfilx TV客户端建议开启】</em></a></th>
																<td colspan="2">
																	...
																	<input type="button" id="merlinclash_clash_routerrules_open" class="ss_btn" style="vertical-align: middle; cursor:pointer;" onclick="open_sniffer();" value="内容编辑" />
												...
												<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_switch_table">
													...
													<tr style="height: 30px;">
														...
														<td colspan="2">
															...
															<div style="display:table-cell;float: left;text-align: center;text-align: center;line-height: 30px;">【护娃狂魔】</div>
															<div class="switch_field" style="display:table-cell;float: left;">
												...
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_switch_table">
														...
														<td colspan="2">
															<div class="SimpleNote" id="head_illustrate">
																...
																<select id="merlinclash_geoip_type" style="width:120px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;" class="input_option">
																	...
																	<!--<option value="Mcore_LCN">M核专用：Loyalsoldier-CN精简版</option>
																	<option value="Mcore_FULL">M核专用：Loyalsoldier-完整版</option>-->
																</select>
													...
													<tr>
														<th>二进制下载</th>
															<td colspan="2">
																...
																<a style="color:#FC0" target="_blank" href="https://github.com/Mazeorz/subconverter/actions/runs/1754202363">【<u>Subconverter-vless</u>】</a>
														...
														<th>二进制上传</th>
															<td colspan="2">
																<div class="SimpleNote" style="display:table-cell;float: left; height: 110px; line-height: 110px; margin:-40px 0;">
																	...
																	<a type="button" style="vertical-align: middle; cursor:pointer;" id="clashbinary-btn-upload" class="ss_btn" onclick="upload_clashbinary()" >上传二进制</a>
																</div>
															</td>		
													</tr>
													<!--<tr>
													...
													<tr id="up_scrule">
														<th>SubConverter&nbsp;&nbsp;规则更新</th>
															<td colspan="2">
																<div class="SimpleNote" id="head_illustrate">																	
																	<a type="button" id="updatescBtn" class="ss_btn" style="cursor:pointer" onclick="sc_update(18)">&nbsp;&nbsp;更新规则&nbsp;&nbsp;</a>
										...
										<div id="tablet_5" style="display: none;">
											<div id="merlinclash-koolproxyL" style="margin:-1px 0px 0px 0px;">
												...
												<div id="merlinclash_koolproxy_ipset_area">										
													...
													<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_koolproxy_ipset_content_table">
														<tr id="kp_ipset_edit_tr">
															<th>IP/域名集编辑 | 一行一个，可以带掩码声明</th>
																<td>
																	<input class="ss_btn" type="button" onclick="kpipsetchange()" value="修改提交">
																	
																</td>
														</tr>
													</table>
													<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
														<div id="merlinclash_koolproxy_ipset_edit_content" style="margin-top:-1px;overflow:hidden;">
															<textarea rows="7" wrap="on" id="merlinclash_koolproxy_ipset_edit_content1" name="koolproxy_ipset_edit_content1" style="margin: 0px; width: 709px; height: 150px; resize: none;" readonly="true"></textarea>
														</div>
													</table>
												</div>	
												<div id="clash_koolproxy_ipsetarround_area">										
													...
													<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_koolproxy_ipsetarround_content_table">
														<tr id="kp_ipsetarround_edit_tr">
															<th>IP/域名集编辑 | 一行一个，可以带掩码声明</th>
																<td>
																	<input class="ss_btn" type="button" onclick="kpipsetarroundchange()" value="修改提交">
																	
																</td>
														</tr>
													</table>
													<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
														<div id="merlinclash_koolproxy_ipsetarround_edit_content" style="margin-top:-1px;overflow:hidden;">
															<textarea rows="7" wrap="on" id="merlinclash_koolproxy_ipsetarround_edit_content1" name="koolproxy_ipsetarround_edit_content1" style="margin: 0px; width: 709px; height: 150px; resize: none;" readonly="true"></textarea>
														</div>
													</table>
												</div>
												...
												<div id="KPYACL_note" style="margin-top: 5px;">
													...
													<div><i>3.如果想在多台装有KP的路由设备上使用一个证书，请用winscp软件备份/koolshare/merlinclash/koolproxy/data文件夹，并上传到另一台路由。</i></div>
													<div><i></br></i></div>
												</div>
											</div>
										</div>
